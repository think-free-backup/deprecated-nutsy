        ...
        sio.sockets.on('connection',function(socket){
            ...
            socket.on('disconnect', function () {
                ...
                if (m_disconnectCallback !== undefined){
                    m_disconnectCallback(m_clientList[socket.handshake.address.address + ":" + socket.handshake.address.address.port]);
                }
                else{
                    console.log('Client disconnected : ' + m_clientListsocket.handshake.address.address + " : " + socket.handshake.address.address.port);
                }

                delete m_clientList[m_clientListsocket.handshake.address.address + ":" + socket.handshake.address.address.port];
